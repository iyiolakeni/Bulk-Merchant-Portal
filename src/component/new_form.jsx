      ...
      if (merchantId) {
        try {
          ...
          const response = await axios.get(
            `http://localhost:5000/merchant/${merchantId}`
          );
    ...
    <div className="form">
      ...
      <form ref={formObj} onSubmit={handleSubmit} className="request">
        ...
        <input
          ...
          name=""
          type="number"
          placeholder="Number of Terminal Locations"
          onChange={handleTableRow}
        />
        <table>
          {/* Table Headers */}
          {numRows > 0 && (
        ...
        {error && <p>{error}</p>}
        <select>
          <option name="Business_Category" value="">
            Select Category of Merchant's Business
          </option>
          <option name="Business_Category" value="Store/Supermarket">
            Store/Supermarket
          </option>
          <option name="Business_Category" value="Restaurants">
            Restaurants
          </option>
          <option name="Business_Category" value="Wholesale/Distributor">
            Wholesale/Distributor
          </option>
          <option name="Business_Category" value="Telecoms">
            Telecoms
          </option>
          <option name="Business_Category" value="Fuel Station">
            Fuel Station
          </option>
          <option name="Business_Category" value="Hotel/Guest House">
            Hotel/Guest House
          </option>
          <option name="Business_Category" value="Logistics(Courier)">
            Logistics(Courier)
          </option>
          <option name="Business_Category" value="Church/NGO">
            Church/NGO
          </option>
          <option name="Business_Category" value="Hospital">
            Hospital
          </option>
          <option name="Business_Category" value="Airlines">
            Airlines
          </option>
          <option name="Business_Category" value="Fast Food">
            Fast Food
          </option>
          <option name="Business_Category" value="Travel Agencies">
            Travel Agencies
          </option>
          <option name="Business_Category" value="Embassy">
            Embassy
          </option>
          <option name="Business_Category" value="Education/School">
            Education/School
          </option>
          <option name="Business_Category" value="Others">
            Others
          </option>
        </select>
        <input
        ...
        <select>
          ...
          <option name="CardType" value="Local Card">
            Local Card
          </option>
          <option name="CardType" value="International Mastercard">
            International Mastercard
          </option>
          <option name="CardType" value="International Visa">
            International Visa
          </option>
          <option name="CardType" value="None">
            None
          </option>
        </select>
        <label>
          <input type="checkbox" checked={certify} onChange={handleCheckBox} />I{" "}
          {user.firstname} {user.surname}, on behalf of {businessTradeName},
          hereby certify that the information provided in this form is true and
          accurate. I agree that I reserve the right to take appropriate
          measures including legal actions if the information here is discovered
          to be false.
        </label>
